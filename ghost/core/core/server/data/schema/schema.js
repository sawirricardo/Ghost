...
module.exports = {
    ...
    automation_run_steps: {
        ...
        created_at: {type: 'dateTime', nullable: false},
        updated_at: {type: 'dateTime', nullable: false},
        automation_run_id: {type: 'string', maxlength: 24, nullable: false, references: 'automation_runs.id'},
        automation_action_revision_id: {type: 'string', maxlength: 24, nullable: false, references: 'automation_action_revisions.id'},
